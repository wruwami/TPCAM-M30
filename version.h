...
========================================================================================================
--------------------------------------------------------------------------------------------------------
2023.11.27  13:00   v0.0.0.21 - KMS
    1. bug fix(enforcement mode HUD, FileSystemWatcher)

--------------------------------------------------------------------------------------------------------
2023.11.27  11:00   v0.0.0.20 - KMS
    1. bug fix(enforcement mode NightMode)

--------------------------------------------------------------------------------------------------------
2023.11.21  20:00   v0.0.0.19 - KMS
    1. bug fix(enforcement mode catpure speed)

--------------------------------------------------------------------------------------------------------
2023.11.21  16:00   v0.0.0.18 - KMS
    1. remove mouse cursor
    2. modify image url in qss files

--------------------------------------------------------------------------------------------------------
2023.11.20  11:00   v0.0.0.17 - KMS
    1. modify ui(button height)

--------------------------------------------------------------------------------------------------------
2023.11.20  10:00   v0.0.0.16 - KMS
    1. bug fix(Filemanager - file list name, video priview, table focusing)

--------------------------------------------------------------------------------------------------------
2023.11.20  09:00   v0.0.0.15 - KMS
    1. modify ui(movieviewer)
    2. bug fix(QtAVPlayer, setting5 ethernet combobox)

--------------------------------------------------------------------------------------------------------
2023.11.17  10:20   v0.0.0.14 - LJH
    1. target cross bug fix
    2. video save bug fix
